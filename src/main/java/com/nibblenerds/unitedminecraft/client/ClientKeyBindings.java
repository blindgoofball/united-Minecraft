...
public final class ClientKeyBindings {
	public static final KeybindAction NARRATE_COORDINATES =
			new KeybindAction("narrate_coordinates", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_C, 0));
	/** Was Shift+C - see {@link #NARRATE_LIGHT_LEVEL}. */
	public static final KeybindAction NARRATE_LIGHT_LEVEL = new KeybindAction(
			"narrate_light_level", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_C, InputConstants.MOD_SHIFT));

	public static final KeybindAction NARRATE_HEALTH =
			new KeybindAction("narrate_health", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_H, 0));
	...
	public static final KeybindAction NARRATE_EXPERIENCE = new KeybindAction(
			"narrate_experience", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_H, InputConstants.MOD_SHIFT));
	public static final KeybindAction NARRATE_ARMOR_AND_EFFECTS = new KeybindAction(
			"narrate_armor_and_effects", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_H, InputConstants.MOD_ALT));
	...
	public static final KeybindAction NARRATE_BEARING =
			new KeybindAction("narrate_bearing", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_B, 0));
	...
	public static final KeybindAction RESET_ROTATION_TO_NORTH = new KeybindAction("reset_rotation_to_north",
			KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_B, InputConstants.MOD_SHIFT));

	public static final KeybindAction SCAN_SURROUNDINGS =
			new KeybindAction("scan_surroundings", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_R, 0));
	...
	public static final KeybindAction TOGGLE_AUTO_CROSSHAIR_NARRATION = new KeybindAction(
			"toggle_auto_crosshair_narration", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_R, InputConstants.MOD_SHIFT));

	public static final KeybindAction NARRATE_TIME =
			new KeybindAction("narrate_time", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_V, 0));
	...
	public static final KeybindAction NARRATE_WEATHER_AND_MOON = new KeybindAction(
			"narrate_weather_and_moon", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_V, InputConstants.MOD_SHIFT));

	public static final KeybindAction PLACE_MARKER =
			new KeybindAction("place_marker", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_U, 0));
	...
	public static final KeybindAction SCANNER_NAME_FOCUSED_ITEM = new KeybindAction(
			"scanner_name_focused_item", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_U, InputConstants.MOD_SHIFT));

	public static final KeybindAction TOGGLE_BUILD_MODE =
			new KeybindAction("toggle_build_mode", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_I, 0));
	...
	public static final KeybindAction BUILD_MODE_RECENTER_CURSOR = new KeybindAction("build_mode_recenter_cursor",
			KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_I, InputConstants.MOD_ALT), KeybindContext.BUILD_MODE);
	...
	public static final KeybindAction BUILD_PLACE = new KeybindAction(
			"build_place", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_RCONTROL, 0), KeybindContext.BUILD_MODE);
	...
	public static final KeybindAction BUILD_BREAK = new KeybindAction(
			"build_break", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_RSHIFT, 0), KeybindContext.BUILD_MODE);

	public static final KeybindAction BUILD_WALK_TO_CURSOR =
			new KeybindAction("build_walk_to_cursor", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_G, 0));

	public static final KeybindAction BUILD_CYCLE_FACING = new KeybindAction(
			"build_cycle_facing", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_J, 0), KeybindContext.BUILD_MODE);
	...
	public static final KeybindAction BUILD_CYCLE_FACING_REVERSE = new KeybindAction("build_cycle_facing_reverse",
			KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_J, InputConstants.MOD_ALT), KeybindContext.BUILD_MODE);
	...
	public static final KeybindAction BUILD_TOGGLE_UPPER_HALF = new KeybindAction("build_toggle_upper_half",
			KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_J, InputConstants.MOD_CONTROL), KeybindContext.BUILD_MODE);
	...
	public static final KeybindAction TOGGLE_COMBAT_MODE =
			new KeybindAction("toggle_combat_mode", KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_K, 0));

	public static final KeybindAction WATER_ESCAPE =
			new KeybindAction("water_escape", KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_Y, 0));
	...
	public static final KeybindAction WATER_ESCAPE_AUTO_SWIM = new KeybindAction("water_escape_auto_swim",
			KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_Y, InputConstants.MOD_SHIFT));

	public static final KeybindAction TRAIL =
			new KeybindAction("trail", KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_X, 0));
	...
	public static final KeybindAction LOOK_LEFT =
			new KeybindAction("look_left", KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_LEFT, 0));
	public static final KeybindAction LOOK_RIGHT =
			new KeybindAction("look_right", KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_RIGHT, 0));
	public static final KeybindAction LOOK_UP =
			new KeybindAction("look_up", KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_UP, 0));
	public static final KeybindAction LOOK_DOWN =
			new KeybindAction("look_down", KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_DOWN, 0));
	...
	public static final KeybindAction SNAP_TURN_LEFT = new KeybindAction("snap_turn_left",
			KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_LEFT, InputConstants.MOD_ALT), KeybindContext.NORMAL_LOOK);
	public static final KeybindAction SNAP_TURN_RIGHT = new KeybindAction("snap_turn_right",
			KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_RIGHT, InputConstants.MOD_ALT), KeybindContext.NORMAL_LOOK);
	public static final KeybindAction SNAP_TURN_UP = new KeybindAction("snap_turn_up",
			KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_UP, InputConstants.MOD_ALT), KeybindContext.NORMAL_LOOK);
	public static final KeybindAction SNAP_TURN_DOWN = new KeybindAction("snap_turn_down",
			KeybindCategory.MOVEMENT_AND_MODES, new Keybind(InputConstants.KEY_DOWN, InputConstants.MOD_ALT), KeybindContext.NORMAL_LOOK);
	...
	public static final KeybindAction BUILD_CURSOR_LEFT = new KeybindAction(
			"build_cursor_left", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_LEFT, 0), KeybindContext.BUILD_MODE);
	public static final KeybindAction BUILD_CURSOR_RIGHT = new KeybindAction(
			"build_cursor_right", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_RIGHT, 0), KeybindContext.BUILD_MODE);
	public static final KeybindAction BUILD_CURSOR_UP = new KeybindAction(
			"build_cursor_up", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_UP, 0), KeybindContext.BUILD_MODE);
	public static final KeybindAction BUILD_CURSOR_DOWN = new KeybindAction(
			"build_cursor_down", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_DOWN, 0), KeybindContext.BUILD_MODE);
	...
	public static final KeybindAction BUILD_REORIENT_LEFT = new KeybindAction("build_reorient_left",
			KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_LEFT, InputConstants.MOD_ALT), KeybindContext.BUILD_MODE);
	public static final KeybindAction BUILD_REORIENT_RIGHT = new KeybindAction("build_reorient_right",
			KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_RIGHT, InputConstants.MOD_ALT), KeybindContext.BUILD_MODE);
	...
	public static final KeybindAction BUILD_CURSOR_ASCEND = new KeybindAction(
			"build_cursor_ascend", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_PAGEUP, 0), KeybindContext.BUILD_MODE);
	public static final KeybindAction BUILD_CURSOR_DESCEND = new KeybindAction(
			"build_cursor_descend", KeybindCategory.BUILD_MODE, new Keybind(InputConstants.KEY_PAGEDOWN, 0), KeybindContext.BUILD_MODE);

	public static final KeybindAction PAGE_UP =
			new KeybindAction("page_up", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_PAGEUP, 0));
	public static final KeybindAction PAGE_DOWN =
			new KeybindAction("page_down", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_PAGEDOWN, 0));
	...
	public static final KeybindAction SCANNER_PAGE_UP_SAME_TYPE = new KeybindAction(
			"scanner_page_up_same_type", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_PAGEUP, InputConstants.MOD_ALT));
	public static final KeybindAction SCANNER_PAGE_DOWN_SAME_TYPE = new KeybindAction(
			"scanner_page_down_same_type", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_PAGEDOWN, InputConstants.MOD_ALT));

	public static final KeybindAction SCANNER_PREV_CATEGORY =
			new KeybindAction("scanner_prev_category", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_HOME, 0));
	...
	public static final KeybindAction SCANNER_REMOVE_MARKER =
			new KeybindAction("scanner_remove_marker", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_DELETE, 0));
	public static final KeybindAction SCANNER_COORDINATES =
			new KeybindAction("scanner_coordinates", KeybindCategory.SCANNER, new Keybind(InputConstants.KEY_BACKSLASH, 0));

	public static final KeybindAction OPEN_SETTINGS =
			new KeybindAction("open_settings", KeybindCategory.GENERAL, new Keybind(InputConstants.KEY_F6, 0));

	public static final KeybindAction NARRATE_BOSS_BARS =
			new KeybindAction("narrate_boss_bars", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_SEMICOLON, 0));

	public static final KeybindAction NARRATE_SCOREBOARD =
			new KeybindAction("narrate_scoreboard", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_APOSTROPHE, 0));
	/** Was Alt+' - see {@link #NARRATE_SCOREBOARD_FULL}. */
	public static final KeybindAction NARRATE_SCOREBOARD_FULL = new KeybindAction(
			"narrate_scoreboard_full", KeybindCategory.NARRATION, new Keybind(InputConstants.KEY_APOSTROPHE, InputConstants.MOD_ALT));
	...
	public static final KeybindAction CONTAINER_SWITCH_SECTION_NEXT = new KeybindAction("container_switch_section_next",
			KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_TAB, 0), KeybindContext.CONTAINER_SCREEN);
	...
	public static final KeybindAction CONTAINER_SWITCH_SECTION_PREV = new KeybindAction("container_switch_section_prev",
			KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_TAB, InputConstants.MOD_SHIFT), KeybindContext.CONTAINER_SCREEN);

	public static final KeybindAction CONTAINER_NAV_LEFT = new KeybindAction(
			"container_nav_left", KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_LEFT, 0), KeybindContext.CONTAINER_SCREEN);
	public static final KeybindAction CONTAINER_NAV_RIGHT = new KeybindAction(
			"container_nav_right", KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_RIGHT, 0), KeybindContext.CONTAINER_SCREEN);
	public static final KeybindAction CONTAINER_NAV_UP = new KeybindAction(
			"container_nav_up", KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_UP, 0), KeybindContext.CONTAINER_SCREEN);
	public static final KeybindAction CONTAINER_NAV_DOWN = new KeybindAction(
			"container_nav_down", KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_DOWN, 0), KeybindContext.CONTAINER_SCREEN);
	...
	public static final KeybindAction CONTAINER_PICKUP = new KeybindAction(
			"container_pickup", KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_RETURN, 0), KeybindContext.CONTAINER_SCREEN);
	...
	public static final KeybindAction CONTAINER_PICKUP_SPLIT = new KeybindAction("container_pickup_split",
			KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_RETURN, InputConstants.MOD_CONTROL), KeybindContext.CONTAINER_SCREEN);
	...
	public static final KeybindAction CONTAINER_QUICK_MOVE = new KeybindAction("container_quick_move",
			KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_RETURN, InputConstants.MOD_SHIFT), KeybindContext.CONTAINER_SCREEN);
	...
	public static final KeybindAction CREATIVE_SWITCH_TAB_PREV = new KeybindAction(
			"creative_switch_tab_prev", KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_HOME, 0), KeybindContext.CONTAINER_SCREEN);
	public static final KeybindAction CREATIVE_SWITCH_TAB_NEXT = new KeybindAction(
			"creative_switch_tab_next", KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_END, 0), KeybindContext.CONTAINER_SCREEN);
	public static final KeybindAction CREATIVE_PAGE_UP = new KeybindAction("creative_page_up",
			KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_PAGEUP, 0), KeybindContext.CONTAINER_SCREEN, ContainerScope.CREATIVE_TABS);
	public static final KeybindAction CREATIVE_PAGE_DOWN = new KeybindAction("creative_page_down",
			KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_PAGEDOWN, 0), KeybindContext.CONTAINER_SCREEN, ContainerScope.CREATIVE_TABS);
	...
	public static final KeybindAction RECIPE_BOOK_TOGGLE_CRAFTABLE_FILTER = new KeybindAction("recipe_book_toggle_craftable_filter",
			KeybindCategory.INVENTORY, new Keybind(InputConstants.KEY_F, 0), KeybindContext.CONTAINER_SCREEN, ContainerScope.RECIPE_BOOK);
	...
	private static final int[] MODIFIER_KEYS = {
			...
			InputConstants.KEY_LGUI, InputConstants.KEY_RGUI,
	};
